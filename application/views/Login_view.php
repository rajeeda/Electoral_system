                ...
                <div class="page-content">
					...
					else
					{
                     ...
                     <span class="profile-picture">
                      <img id="avatar" alt="" src="" height="50">
                     </span>
                     </div>
                    </div>
                     <?php
                        ...
                        <div class="span12">
                            <div class="span6 pull-left hidden-phone">
                                ...
                                <div>
                                    ...
                                    <div class="row-fluid">
                                        <blockquote>
                                            <p>IT solutions for credit unions.</p>
                                            <small>
                                                <cite title="Source Title">Rajeeda holdings pvt ltd</cite>
                                            </small>
                                        </blockquote>
                                    </div>	
                                </div>
                            </div>
                            <div class="span4 pull-left widget-container-span">
